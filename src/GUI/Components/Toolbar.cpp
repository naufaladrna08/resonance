...
void Toolbar::render() {
  ...
  ImGui::PushStyleVar(ImGuiStyleVar_FrameRounding, 4.0f);
    ...
    // Playbacks
    ImGui::SetCursorPosY(8); createButton(ICON_LC_SKIP_BACK, "Skip back", false, "Skip back", nullptr, ImVec2(72, 72));
    ImGui::SetCursorPosY(8); createButton(ICON_LC_SKIP_FORWARD, "Skip forward", false, "Skip forward", nullptr, ImVec2(72, 72)); 
    ImGui::SetCursorPosY(8); createButton(ICON_LC_PLAY, "Play", false, "Play/pause track", nullptr, ImVec2(72, 72));
    ImGui::SetCursorPosY(8); createButton(ICON_LC_CIRCLE, "Play", false, "Toggle record", nullptr, ImVec2(72, 72), ImVec4(0.8f, 0.2f, 0.2f, 1.0f));
